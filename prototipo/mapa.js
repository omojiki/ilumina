...
function redirectToDenuncia() {
    ...
    // Redirecione para a página de denúncia com os parâmetros na URL
    window.location.href = 'denuncia.html?rua=' + ruaCodificada + '&cep=' + cepCodificado + '&latitude=' + latitudeCodificada + '&longitude=' + longitudeCodificada;
}